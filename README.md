...
- [x] 1. [数组过于简单，但你该了解这些！](./problems/数组理论基础.md) 
...
- [x] 2. [哈希表：有效的字母异位词](./problems/0242.有效的字母异位词.md)
- [ ] 3. [哈希表：查找常用字符](./problems/1002.查找常用字符.md)
- [ ] 4. [哈希表：两个数组的交集](./problems/0349.两个数组的交集.md)
- [x] 5. [哈希表：快乐数](./problems/0202.快乐数.md)
- [x] 6. [哈希表：两数之和](./problems/0001.两数之和.md)
- [ ] 7. [哈希表：四数相加II](./problems/0454.四数相加II.md)
- [x] 8. [哈希表：赎金信](./problems/0383.赎金信.md)
...
- [x] 1. [栈与队列：来看看栈和队列不为人知的一面](./problems/栈与队列理论基础.md)
- [x] 2. [栈与队列：用栈实现队列](./problems/0232.用栈实现队列.md)
- [x] 3. [栈与队列：用队列实现栈](./problems/0225.用队列实现栈.md)
- [x] 4. [栈与队列：有效的括号](./problems/0020.有效的括号.md)
- [x] 5. [栈与队列：删除字符串中的所有相邻重复项](./problems/1047.删除字符串中的所有相邻重复项.md)
- [x] 6. [栈与队列：逆波兰表达式求值](./problems/0150.逆波兰表达式求值.md)
...
- [x] 1. [关于二叉树，你该了解这些！](./problems/二叉树理论基础.md)
- [x] 2. [二叉树：二叉树的递归遍历](./problems/二叉树的递归遍历.md)
...
- [x] 13. [二叉树：二叉树的所有路径](./problems/0257.二叉树的所有路径.md)
...
- [x] 17. [二叉树：找树左下角的值](./problems/0513.找树左下角的值.md)
- [x] 18. [二叉树：路径总和](./problems/0112.路径总和.md)
- [ ] 19. [二叉树：构造二叉树](./problems/0106.从中序与后序遍历序列构造二叉树.md)
- [x] 20. [二叉树：最大二叉树](./problems/0654.最大二叉树.md)
21. [本周小结！（二叉树系列三）](./problems/周总结/20201010二叉树周末总结.md) 
- [ ] 22. [二叉树：合并两个二叉树](./problems/0617.合并二叉树.md)
- [x] 23. [二叉树：二叉搜索树登场！](./problems/0700.二叉搜索树中的搜索.md)
- [ ] 24. [二叉树：验证二叉搜索树](./problems/0098.验证二叉搜索树.md)
- [ ] 把BST展開成陣列，相鄰兩值比較差值，注意pre的設定 25. [二叉树：搜索树的最小绝对差](./problems/0530.二叉搜索树的最小绝对差.md)
...
- [ ] solved 2. [回溯算法：组合问题](./problems/0077.组合.md)
- [ ] solved 3. [回溯算法：组合问题再剪剪枝](./problems/0077.组合优化.md)
- [ ] solved 4. [回溯算法：求组合总和！](./problems/0216.组合总和III.md)
- [ ] solved 5. [回溯算法：电话号码的字母组合](./problems/0017.电话号码的字母组合.md)
6. [本周小结！（回溯算法系列一）](./problems/周总结/20201030回溯周末总结.md)
- [ ] solved 7. [回溯算法：求组合总和（二）](./problems/0039.组合总和.md)
- [ ] solved 8. [回溯算法：求组合总和（三）](./problems/0040.组合总和II.md)
- [ ] solved 9. [回溯算法：分割回文串](./problems/0131.分割回文串.md)
- [ ] solved 10. [回溯算法：复原IP地址](./problems/0093.复原IP地址.md)
...
- [x] 1. [关于贪心算法，你该了解这些！](./problems/贪心算法理论基础.md)
...
- [x] 7. [贪心算法：跳跃游戏](./problems/0055.跳跃游戏.md)
- [x] 8. [贪心算法：跳跃游戏II](./problems/0045.跳跃游戏II.md)
...
- [x] 2. [动态规划：斐波那契数](./problems/0509.斐波那契数.md)
- [x] 3. [动态规划：爬楼梯](./problems/0070.爬楼梯.md)
- [x] 4. [动态规划：使用最小花费爬楼梯](./problems/0746.使用最小花费爬楼梯.md)
5. [本周小结！（动态规划系列一）](./problems/周总结/20210107动规周末总结.md)
- [ ] 二叉樹, 數論, 1d array optimize. 6. [动态规划：不同路径](./problems/0062.不同路径.md)
- [ ] 1d array optimize 7. [动态规划：不同路径还不够，要有障碍！](./problems/0063.不同路径II.md)
