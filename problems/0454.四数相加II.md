...
本题一看好像和[0015.三数之和](https://programmercarl.com/0015.三数之和.html)，[0018.四数之和](https://programmercarl.com/0018.四数之和.html)差不多，其实差很多。
...
1. 首先定义 一个unordered_map
2. 遍历大A和大B数组, key放a+b，value 放a+b出现的次数。
